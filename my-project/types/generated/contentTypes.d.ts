...
export interface ApiCoachCoach extends Schema.CollectionType {
  ...
  attributes: {
    ...
    team: Attribute.Relation<'api::coach.coach', 'oneToOne', 'api::team.team'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDataImporterDataImporter extends Schema.CollectionType {
  collectionName: 'data_importers';
  info: {
    singularName: 'data-importer';
    pluralName: 'data-importers';
    displayName: 'dataImporter';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::data-importer.data-importer',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  attributes: {
    ...
    coach: Attribute.Relation<'api::team.team', 'oneToOne', 'api::coach.coach'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::data-importer.data-importer': ApiDataImporterDataImporter;
